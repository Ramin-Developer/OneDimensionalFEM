...
- `src/matlab/` – MATLAB implementation and entry-point scripts
- `tests/` – regression and validation tests
- `docs/latex/` – LaTeX sources and figures for the report
- `docs/reference/` – supporting reference material
...
```bash
git clone https://github.com/Ramin-Developer/OneDimensionalFEM.git
```
