...
\begin{definition}	\label{def:SpaceL2}
	...
	\begin{equation}
		\glssymbol{spaceL2} = \left\{ \varphi \left( x \right) \bigg \vert \int_0^1 \varphi \left( x \right) \dd x < \infty \right\}.
	\end{equation}
\end{definition}
%
...
\begin{definition}	\label{def:L2_Inner_product}
	...
	\begin{subequations}
		\begin{equation}	\label{eqn:L2_Inner_product}
			\glssymbol{L2InnerProduct} = \int_0^1 f \left( ssx \right) g \left( x \right) \dd x,
		\end{equation}
