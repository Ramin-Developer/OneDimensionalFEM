...
\begin{definition}	\label{def:Max_Error}
	...
	\end{align}
\end{definition}
In this report we have chosen the $L^2$ error norm, denoted by $E_{sq}$, for measuring the deviation. Having defined an error measure we move forward and define a
\gls{convFactor}.
%
\begin{definition} \label{def:Conv_Factor}
	...
	and $E_{2}$ indicate the $L^2$ error norms, see \cref{def:L2_Error}. Define a \gls{convFactor} by
