...
\begin{table}
	...
	\begin{tabular}{| c | c | c | c | c | c |} \hline
		...
		% A constant
		$f_{n} \left( x \right) = 1$ & $4$ & \num{7.6 e-4} & \num{2.3 e-6} & - & - \\ \hline
		$f_{n} \left( x \right) = 1$ & $8$& \num{2.0 e-4} & \num{1.3 e-7} & $3.89$ & $17.0$	\\ \hline
		$f_{n} \left( x \right) = 1$ & $16$ & \num{5.0 e-5} & \num{8.2 e-9} & $3.94$ & $16.2$	\\ \hline
		% A linear function
		$f_{n} \left( x \right) = 1 + 2x$ & $4$	& \num{1.3 e-3} & \num{7.3 e-6} & - & - \\ \hline
		$f_{n} \left( x \right) = 1 + 2x$ & $8$	& \num{3.5 e-4} & \num{4.4 e-7} & $3.83$ & $16.7$ \\ \hline
		$f_{n} \left( x \right) = 1 + 2x$ & $16$ & \num{8.8 e-5} & \num{2.7 e-8} & $3.93$ & $16.2$ \\ \hline
		% A quadratic function
		$f_{n} \left( x \right) = 1 + 2x - 3x^2$ & $4$ & \num{6.5 e-4} & \num{3.4 e-6} & -& - \\ \hline
		$f_{n} \left( x \right) = 1 + 2x - 3x^2$ & $8$ & \num{1.6 e-4} & \num{2.4 e-7} & $3.94$ & $13.9$ \\ \hline
		$f_{n} \left( x \right) = 1 + 2x - 3x^2$ & $16$ & \num{4.2 e-5} & \num{1.6 e-8} & $3.95$ & $15.4$ \\ \hline
	\end{tabular}
...
\begin{table}
	...
	\begin{tabular}{| c | c | c | c | c | c |} \hline
		...
		% A constant
		$f_{n} \left( x \right) = 1$ & $4$ & \num{5.2 e-3}	& \num{1.6 e-5} & - & - \\ \hline
		$f_{n} \left( x \right) = 1$ & $8$	& \num{1.3 e-3} & \num{1.0 e-6} & $3.92$ & $15.6$ \\ \hline
		$f_{n} \left( x \right) = 1$ & $16$ & \num{3.3 e-4} & \num{6.6 e-8} & $3.98$ & $15.9$ \\ \hline
		% A linear function
		$f_{n} \left( x \right) = 1 + 2x$ & $4$	& \num{1.5 e-2} & \num{7.5 e-5} & - & - \\ \hline
		$f_{n} \left( x \right) = 1 + 2x$ & $8$	& \num{3.9 e-3} & \num{4.8 e-6} & $3.87$ & $15.5$ \\ \hline
		$f_{n} \left( x \right) = 1 + 2x$ & $16$ & \num{9.8 e-4} & \num{3.0 e-7} & $3.97$ & $15.9$ \\ \hline
		% A quadratic function
		$f_{n} \left( x \right) = 1+2x-3x^2$ & $4$ & \num{4.4 e-3} & \num{6.5 e-5} & - & - \\ \hline
		$f_{n} \left( x \right) = 1+2x-3x^2$ & $8$ & \num{1.1 e-3} & \num{4.3 e-6} & $3.87$ & $15.0$ \\ \hline
		$f_{n} \left( x \right) = 1+2x-3x^2$ & $16$	& \num{2.9 e-4} & \num{2.7 e-7} & $3.96$ & $15.7$ \\ \hline
