...
\begin{enumerate}	\label{itm:Parameter_Values}
	...
	\end{align*}
	\item Calculate each solution by both linear and cubic \glspl{basisFunction}. In each case set No. of elements as
	\begin{equation*}
...
\begin{remark}
	...
	the first derivative are discontinuous at \glspl{nodePoint}. This is clearly seen in node points when No. of elements small,
