...
\begin{equation}	\label{eqn:FEM_1st_Der_Error_8}
	\Big \vert E \Big \vert_{ H^1 \left( \Omega_e \right) }^2 = h^2 \Big \vert u \Big \vert_{ H^2 \left( \Omega_e \right) }^2.
\end{equation}
...
\begin{equation}	\label{eqn:FEM_1st_Der_Error}
	\big \vert E \big \vert_{ H^1 } = \big\| E^{\prime } \big\|_{ L^2 } = h \big \vert u \big \vert_{ H^2 }.
\end{equation} \\
...
\begin{equation}	\label{eqn:FEM_Error_5}
	\big\| E \big\|_{ L^2 } = h^2 \big \vert u \big \vert_{ H^2 }.
\end{equation}
...
\end{equation}
Taking square roots of \cref{eqn:Orthogonality_e_Wh_3} results in
