...
As we will see this gives a diagonal \gls{stiffnessMatrix}. In a \gls{diagonalMatrix} all non-zero entries are on the diagonals.
The \gls{stiffnessMatrix} is in addition sparse. In a \gls{sparseMat}, most of entries are zero. In the literature we may find
