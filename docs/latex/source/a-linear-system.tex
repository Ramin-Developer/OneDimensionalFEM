...
functions are easy to evaluate. The \gls{localSupport} means that $\varphi_{i}$ is only nonzero over a few \glspl{element}.
...
It would be then desirable that these functions are continuous at the junction. We may also be interested in more
