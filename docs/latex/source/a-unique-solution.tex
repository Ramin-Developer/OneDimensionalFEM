...
Before imposing the essential boundary condition, the assembled stiffness matrix is positive semidefinite because its nullspace
contains the constant function. Restricting the discrete space to functions satisfying the homogeneous essential condition at the
left boundary restores uniqueness.
