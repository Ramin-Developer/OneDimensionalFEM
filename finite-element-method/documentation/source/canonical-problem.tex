...
\begin{enumerate}
	...
	\begin{equation}	\label{eqn:Property_Bilinear}		
		\begin{aligned}
			...
			a \left( u, w + \beta v \right) &= \alpha a \left( u, w \right) + \beta a \left( u, v \right).
		\end{aligned}
	\end{equation}		
	...
	taken to be trivially $1$ in our case. In more general settings it can differ from unity, but is always dependent of $f$ and $g$.
	...
	In high dimensions, such estimates mat be non-trivial to establish.} 
